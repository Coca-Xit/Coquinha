...
module.exports = {
  name: "warnings",
  description: "listar ou limpar os avisos do usuário",
  category: "MODERATION",
  ...
  command: {
    ...
    subcommands: [
      {
        trigger: "list [member]",
        description: "listar todos os avisos de um usuário",
      },
      {
        trigger: "clear <member>",
        description: "limpar todos os avisos de um usuário",
      },
    ],
  },
  slashCommand: {
